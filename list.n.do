...
foreach ($versions as $appversion)
{
    ...
    print "<div class=\"versiondiv\"><h3 class=\"versionspan\">版本：未知</h3>";	
   else 
...
<hr>
<span class="buildspan">BuildId: 手动上传应用 </span><span class="buildspan">代码分支: $buildinfo[1]</span><span class="buildspan">环境: $buildinfo[2]</span><span class="buildspan">上传时间: $buildinfo[6]</span><span class="buildspan">无更新记录</span><br/><span class="buildspan comments">备注: $buildinfo[5]</span>
