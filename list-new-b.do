...
$sort = $_GET['sort'];
if (isset($_GET['type'])) {
    if ($type != "ios" && $type != "android") $type = "android";
    else $type = $_GET['type'];
}
if ($type == "android") $location = "/home/ci/jobs/ANDROID构建/builds/";
else if ($type == "ios") $location = "/home/ci/jobs/IOS构建/builds/";
?>
...
<h2><?php $capitaltype = strtoupper($type);
echo $capitaltype; ?></h2>
<div class="app-list">
